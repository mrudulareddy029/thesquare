...
export default function CommunitySection() {
  return (
    <section className="w-full relative h-auto lg:h-[520px] overflow-hidden" id="community">
      ...
      {/* OVERLAY */}
      <div className="hidden lg:block absolute inset-0 bg-black/55 z-[5]"></div>

      {/* CONTENT WRAPPER */}
      <div className="relative z-10 w-full px-6 py-12 bg-white text-center lg:absolute lg:inset-0 lg:bg-transparent lg:flex lg:flex-col lg:justify-center lg:items-center lg:py-0 lg:px-0">
